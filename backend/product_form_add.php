  ...
  <div class="row">
      <form  name="addproduct" action="product_form_add_db.php" method="POST" enctype="multipart/form-data"  class="form-horizontal">
        ...
        <div class="form-group">
          <div class="col-sm-9">
            <p> ราคาสินค้า</p>
            <input type="text"  name="p_price" class="form-control" required placeholder="ราคาสินค้า" onKeyUp="if(isNaN(this.value)){ alert('ใส่เฉพาะตัวเลข'); this.value='';}" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-8">
            ...
            <select name="type_id" class="form-control" required>
              <option value="type_id">ประเภทอะไหล่</option>
        ...
        <div class="form-group">
          <div class="col-sm-4">
            <p>จำนวนสินค้า</p>
            <input type="text"  name="amount" class="form-control" required placeholder="จำนวนสินค้า" maxlength="3" onKeyUp="if(isNaN(this.value)){ alert('ใส่เฉพาะตัวเลข'); this.value='';}" />
          </div>
        </div>
