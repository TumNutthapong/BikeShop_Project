  ...
  <div class="row">
      <form  name="addproduct" action="product_form_edit_db.php" method="POST" enctype="multipart/form-data"  class="form-horizontal">
        ...
        <div class="form-group">
          <div class="col-sm-9">
            <p> ราคาสินค้า</p>
            <input type="text"  name="p_price" class="form-control" required placeholder="ราคาสินค้า" / value="<?php echo $p_price; ?>" onKeyUp="if(isNaN(this.value)){ alert('ใส่เฉพาะตัวเลข'); this.value='';}">
          </div>
        </div>
         <div class="form-group">
          <div class="col-sm-6">
