...
<center>
<font color="black">
<p><h2>กรอกข้อมูลเพื่อสมัครสมาชิก<h2></p>
<form  name="register" action="member_form_add_db.php" method="POST" class="form-horizontal">
       <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-sm-5" align="left">
            <input  name="m_tel" type="text" class="form-control" id="m_tel"  placeholder="เบอร์โทรศัพท์" minlength="2" maxlength="10" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกเบอร์โทรศัพท์มือถือ'); this.value='';}" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-5" align="left">
