...
WHERE p.type_id = $type_id AND p.cat = 'mtb' 
 ORDER BY p.p_id ASC";
...
<?php foreach ($result_pro as $row_pro) { ?>
    ...
    <h4 class="card-title"><?php echo $row_pro['p_name']; ?></h4>
      <p class="card-text">ประเภท: <?php echo $row_pro['type_name']; ?> , <?php echo $row_pro['cat']; ?> 
      <p class="card-text">สินค้าคงเหลือ: <?php echo $row_pro['amount']; ?> ชิ้น</p>
       <b><center><p style="font-size:40px;"><?php echo number_format($row_pro['p_price']) ; ?> ฿</center></b></p></p>
      <a style="width:100%;" href="product_detail_custom_mtb.php?p_id=<?php echo $row_pro['p_id'] ?>" class="btn btn-primary">รายละเอียด</a>
